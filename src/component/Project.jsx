		...
		<div className="h-fit">
			...
			<div
				...
				<div className="container mx-auto flex justify-center pb-20">
					<div className="lg:grid-cols-2 grid-cols-1 grid gap-8 w-fit  items-center text-sm ">
						<Pitem
							image={require("../assets/audiophile.png")}
							title="Audiophile"
							details="Audiophile is an e-commerce website for audio accessories. It allows users to explore and purchase a wide range of high-quality audio products.
              "
							stack="Next Js || JavaScript || Next Auth || Tailwind || AOS || PayStack"
							link="https://audiophile-ney.vercel.app"
						/>
						<Pitem
							image={require("../assets/artsy.png")}
							title="Artsy"
							details=" Arsty is an e-commerce website for vintage shots, historic images and captures seamlessly in one place."
							stack="React js || Tailwind || Aos || PayStack"
							link="https://arty.vercel.app"
						/>
						<Pitem
							image={require("../assets/kwems.png")}
							title="Kwara Electoral Management System"
							details="Kwara Electoral Management System is an election result portal for Kwara State
              "
							stack="React js || Tailwind "
							link="https://kwems.vercel.app"
						/>
						<Pitem
							image={require("../assets/arch.png")}
							title="Arch Studio"
							details="Arch Studio is an architectural portfolio website"
							stack="React js || Tailwind || Aos"
							link="https://arch-ney.vercel.app"
						/>
